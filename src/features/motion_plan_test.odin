...
motion_plan_hash_rejects_mutated_operation_test :: proc(t: ^testing.T) {
	...
	expected := contracts.Content_Hash{
		0x34, 0x92, 0x55, 0xfe, 0xb9, 0x44, 0xf8, 0x1c,
		0xca, 0xe1, 0x63, 0x77, 0x54, 0x19, 0xa8, 0xf0,
		0xa1, 0x6d, 0xb1, 0xff, 0x0a, 0xba, 0x12, 0xbc,
		0xac, 0x2e, 0x88, 0x68, 0xa5, 0x45, 0x46, 0x5f,
	}
