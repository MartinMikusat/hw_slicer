...
support_path_hash_rejects_mutated_role_test :: proc(t: ^testing.T) {
	...
	expected_hash := contracts.Content_Hash{
		0x85, 0x55, 0xc1, 0x2a, 0x53, 0x0b, 0x45, 0x18,
		0x58, 0xf1, 0x05, 0xcf, 0xc6, 0x44, 0x63, 0xd5,
		0x76, 0x7e, 0x84, 0x50, 0xdd, 0xe5, 0x84, 0x2d,
		0x47, 0x7b, 0x8e, 0x65, 0xac, 0x76, 0x80, 0x5f,
	}
