...
bridge_directions_select_two_sided_short_span_test :: proc(t: ^testing.T) {
	...
	expected_hash := contracts.Content_Hash{
		0x0f, 0x50, 0xab, 0x91, 0x48, 0x36, 0xd0, 0x42,
		0x58, 0x2c, 0xc9, 0x57, 0xe0, 0x96, 0xd0, 0x31,
		0x5c, 0x2f, 0xa0, 0x68, 0x88, 0xfe, 0xfb, 0x82,
		0x9c, 0x16, 0x71, 0xc7, 0x1f, 0x93, 0x7e, 0x36,
	}
...
bridge_direction_vectors_pin_cardinal_and_diagonal_angles_test :: proc(
	...
	testing.expect(t, ok)
	testing.expect_value(t, x, i64(707_107))
	testing.expect_value(t, y, i64(707_107))
